        ...
        <div class="container mt-3">
            <div class="card">
                                    ...
                                    <div>
                                        ...
                                        <select name="projec_fund_relese_id" class="form-select"
                                            ...
                                            @foreach ($projectDetail as $funding)
                                                <option value="{{ $funding->id }}" selected>Project
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control form-control-sm " name="date"
                                        value=" {{ $relese_funds->date }} " id="datefild" aria-describedby="datefild"
                                        require>
                                </div>
                                <div class="col">
                                    {{-- Transtation no --}}
                                    <label for="transtation_no">Transtation No</label>
                                    <input type="text" class="form-control form-control-sm " name="transaction_no"
                                        value=" {{ $relese_funds->transaction_no }} " id="transtation_no"
                                        aria-describedby="transtation_no" placeholder="Enter Your Transtation No"
                                        require>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div id="input" style="display: none;" class="mt-2">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input class="form-control" type="text" id="payment_method_no"
                                                    value=" {{ $relese_funds->payment_method_no }} "
                                                    name="payment_method_no" placeholder="Enter payment Method No" />
                                            </div>
                                            <div class="col">
                                                <!-- <label for="transtation_date">Enter  Date</label>  -->
                                                <input class="form-control" date="text" id="transtation_date"
                                                    value=" {{ $relese_funds->transtation_date }} "
                                                    name="transtation_date" />
                                            </div>
                                            <div class="col">
                                                <!-- <label for="transtation_date">Enter  Date</label>  -->
                                                <input class="form-control" type="text" id="relese_amount"
                                                    name="relese_funds_amount"
                                                    value="{{ $relese_funds->relese_funds_amount }} " />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table class="table" id="products_table">
                                                ...
                                                <tbody>
                                                    @foreach (old('relese_fund_budget_id', ['']) as $index => $oldProduct)
                                                            ...
                                                            <tr id="product{{ $index }}">
                                                                ...
                                                                <td>
                                                                    <input type="txt"
                                                                        ...
                                                                        value=" {{ $budget->fund_relese_budget_amount }} "
                                                        ...
                                                        @endforeach
                                                    @endforeach
                                                    <tr id="product{{ count(old('relese_fund_budget_id', [''])) }}">
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <button id="add_row" class="btn  btn-success pull-left">+ Add
                                                        Row</button>
                ...
                <div class="mt-2 my-2 mx-4">
                    ...
                    <button id="submit" type="submit" disabled class="btn btn-primary float-end"
                        value="{{ trans('global.save') }}">Update</button>
