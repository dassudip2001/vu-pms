    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
        ...
        <div class="card mt-4 mx-2">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        {{-- form --}}
                                        <form action=" {{ route('admin.relesefund.create') }} " method="POST"
                                            name="budgetForm">
                                            @csrf
                                            {{-- form value  --}}
                                            <div class="row">
                                                <div class="col">
                                                    {{-- select project --}}
                                                    <label for="faculty_designation">Select Project<span
                                                            class="required" style="color: red;">*</span></label>
                                                    <div>

                                                        <select name="projec_fund_relese_id" class="form-select"
                                                            aria-label="Default select example" id="selector"
                                                            onchange="yesnoCHEQUE(this);">
                                                            <option value="select">Select Project</option>

                                                            @foreach ($projectDetail as $funding)
                                                                <option value="{{ $funding->id }}">Project
                                                                    No:{{ $funding->project_no }} || Project
                                                                    Name:{{ $funding->project_title }} || Project Cost:
                                                                    {{ $funding->project_total_cost }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    {{-- date --}}
                                                    <label for="datfilde">Date<span class="required"
                                                            style="color: red;">*</span></label>
                                                    <input type="date" class="form-control form-control-sm "
                                                        name="date" id="datefild" aria-describedby="datefild"
                                                        placeholder="Enter Date" require>
                                                    @error('date')
                                                ...
                                                <div class="col">
                                                    {{-- Transtation no --}}
                                                    <label for="transtation_no">Transtation No<span class="required"
                                                            style="color: red;">*</span></label>
                                                    <input type="text" class="form-control form-control-sm "
                                                        name="transaction_no" id="transtation_no"
                                                        aria-describedby="transtation_no"
                                                        placeholder="Enter Your Transtation No" require>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label for="faculty_designation">Payment Recive Method<span
                                                            class="required" style="color: red;">*</span></label>
                                                    <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    id="payment_method_no" name="payment_method_no"
                                                                    placeholder="Enter payment Method No" />
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <input class="form-control" type="date"
                                                                    id="transtation_date" name="transtation_date" />
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <input class="form-control" type="number"
                                                                    id="relese_amount" name="relese_funds_amount"
                                                                    placeholder="Enter Relese Amount" />
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <table class="table" id="products_table">
                                                                ...
                                                                <tbody>
                                                                    @foreach (old('relese_fund_budget_id', ['']) as $index => $oldProduct)
                                                                        <tr id="product{{ $index }}">
                                                                            <td>
                                                                                <select name="relese_fund_budget_id[]"
                                                                                    class="form-control">
                                                                                    <option value="">-- choose
                                                                                        Budget Name --</option>
                                                                            ...
                                                                            <td>
                                                                                <input type="number"
                                                                                    ...
                                                                                    onblur="findTotal()"
                                                                                    id="inst_amount"
                                                                                    name="fund_relese_budget_amount[]"
                                                                                    id="clear"
                                                                    ...
                                                                    @endforeach
                                                                    <tr
                                                                        id="product{{ count(old('relese_fund_budget_id', [''])) }}">
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-10">
                                                                    <button id="add_row"
                                                                        class="btn  btn-success pull-left">+ Add
                                                                        Row</button>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="submit" disabled class="btn btn-primary">Save
                                    changes</button>
                            </div>
                        </div>
                        </form>
            ...
            <div class="card-title mx-3">
                <form action=" {{ route('admin.relesefund.search') }} " method="GET" class="d-flex">
                    <input class="form-control me-2" type="text" name="search "
                        placeholder="Search Using Date or Transtation number" aria-label="Search " required>
