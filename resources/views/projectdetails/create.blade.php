                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="" method="POST" name="budgetForm">
                                                    ...
                                                    <div class="col-md">
                                                        <div class="mb-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                ...
                                                                aria-describedby="project_title"
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-6">
                                                            <label for="funding_agency">Funding Agency<span
                                                                    class="required"
                                                                    style="color: red;">*</span></label>
                                                            ...
                                                            <select name="funding_agency_id"
                                                                ...
                                                                @foreach ($data as $funding)
                                                                    <option value="{{ $funding->id }}" selected>
                                                                        {{ $funding->agency_name }}
                                                                    </option>
                                                                @endforeach
                                                ...
                                                @endforeach --}}
                                                   ...
                                                   @endforeach  --}}
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-6">
                                                            <label for="name">Principle Investigator<span
                                                                    class="required"
                                                                    style="color: red;">*</span></label>
                                                            <br>
                                                            <div class="row">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-md">
                                                        <div>
                                                            <label for="project_scheme">Project Scheme<span
                                                                    class="required"
                                                                    style="color: red;">*</span></label>
                                                            <input type="text" class="form-control form-control-sm"
                                                                name="project_scheme" id="project_scheme"
                                                                aria-describedby="project_scheme"
                                                                placeholder="Enter Project Scheme">
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                                        <div class="mb-6">
                                                            <label for="project_duration">Project Duration<span
                                                                    class="required"
                                                                    style="color: red;">*</span></label>
                                                            <input type="text" class="form-control form-control-sm"
                                                                name="project_duration" id="project_duration"
                                                                aria-describedby="project_duration"
                                                                placeholder="Enter Project Duration">
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                                        <div class="mb-6">
                                                            <label for="project_cost">Project Cost<span
                                                                    class="required"
                                                                    style="color: red;">*</span></label>
                                                            <input type="number" class="form-control form-control-sm"
                                                                name="project_total_cost" id="amount"
                                                                aria-describedby="project_cost"
                                                ...
                                                <div class="card">
                                                                    ...
                                                                    <tr id="product{{ $index }}">
                                                                        <td>
                                                                            <select name="budget_id[]"
                                                                                class="form-control budget-names"
                                                                                id="cars" onclick="checkValue()">
                                                                                {{-- Check whether option is already selected or not --}}
                                                                                <option value="">-- choose Budget
                                                                                    Name --</option>
                                                                        ...
                                                                        <td>
                                                                            <input type="number"
                                                                                ...
                                                                                name="budget_details_amount[]"
                                                                                id="clear"
                                                                                placeholder="Enter Budget Amount" />
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                                <tr id="product{{ count(old('budget_id', [''])) }}">
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    aria-describedby="total_amount" placeholder="0"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class=" my-2 mx-2">
                                                        <button id="submit" type="submit" disabled
                                                            ...
                                                            value="{{ trans('global.save') }}">Create Project</button>
                                ...
                                <table class="table table-striped table-hover">
                                 ...
                                 <td>
                                    ...
                                    @endforeach
                                                ...
                                                <th>
                                                    <a href=" {{ url('/admin/projectdetails/showall', $pro->id) }} ">
