...
class DepartmentController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            if (session('success_massage')) {
                alert()->success('SuccessAlert', 'Department Created Successfully.');
            } 
    ...
    public function create(Request $request)
    {
        ...
        return redirect(route('admin.index'))->withSuccessMassage('success', 'Department Created Successfully', array('timeout' => 3000), 'error');
