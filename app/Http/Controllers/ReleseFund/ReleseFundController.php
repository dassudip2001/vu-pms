...
class ReleseFundController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return redirect(route('admin.relesefund.create'))->with('success', 'Created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect(route('admin.relesefund.index'))
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            // ->delete($id);
            return redirect(route('admin.relesefund.index'))->with('success', 'Delete Successfully');
        } catch (Exception $e) {
